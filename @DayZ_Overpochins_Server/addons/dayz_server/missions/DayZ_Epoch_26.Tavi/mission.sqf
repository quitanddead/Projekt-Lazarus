if (isServer) then {
  ...
  //Bandit Vendors
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\DayZ_Epoch_26.Tavi\bandit.sqf";
  //Bilgrad City
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\DayZ_Epoch_26.Tavi\bilgrad.sqf";
  //Branibor City
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\DayZ_Epoch_26.Tavi\branibor.sqf";
  //Hero Vendors
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\DayZ_Epoch_26.Tavi\hero.sqf";
  //Lyepenstok City
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\DayZ_Epoch_26.Tavi\lyepestok.sqf";
  //Misc. Vendors
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\DayZ_Epoch_26.Tavi\miscvendors.sqf";
  //Sabina City
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\DayZ_Epoch_26.Tavi\sabina.sqf";
  //Wholesalers
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\DayZ_Epoch_26.Tavi\wholesalers.sqf";
